...
[Propuesta de proyecto](https://github.com/vvitoop/StarWarsGalacticRebellion/wiki)

## Como compilar y Ejecutar

1. Clonar Repositorio
   ```
   git clone https://github.com/vvitop/StarWarsGalacticRebellion.git
   cd StarWarsGalacticRebellion
   ```
